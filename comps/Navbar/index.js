...
export default function NavBar({ goBack, visible = "visible" }) {
  ...
  return (
    <NavCont navcolor={global_theme[theme].nav}>
      ...
      <Burger
        menucolor={open ? "black" : global_theme[theme].menu}
        open={open}
      ...
      <Ul open={open}>
        <Li
          ...
          open={open}
        >
          <Icon src="/home.svg" /> HOME
        </Li>
        <Li
          onClick={() => {
            {
              router.push(`/saved/${uuidv4()}`);
            }
            saveFav;
          }}
          open={open}
        >
          <Icon src="/saved.svg" /> SAVED
        </Li>
        <Li
          onClick={() => {
          ...
          open={open}
        >
          <Icon src="/settings.svg" /> SETTINGS
        </Li>
        <Li
          onClick={() => {
            router.push("/");
